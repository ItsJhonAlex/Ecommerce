CREATE TYPE "public"."order_status" AS ENUM('pending_payment', 'paid', 'preparing', 'shipped', 'delivered', 'cancelled');--> statement-breakpoint
CREATE TYPE "public"."payment_method" AS ENUM('cod', 'transfer_local', 'zelle');--> statement-breakpoint
...
CREATE TABLE "product_prices" (
	...
	CONSTRAINT "product_prices_product_currency_uq" UNIQUE("product_id","currency")
);
--> statement-breakpoint
...
CREATE TABLE "orders" (
	...
	"ship_municipality" text NOT NULL,
...
CREATE TABLE "shipping_rates" (
	...
	CONSTRAINT "shipping_rates_province_currency_uq" UNIQUE("province","currency")
);
--> statement-breakpoint
...
ALTER TABLE "payments" ADD CONSTRAINT "payments_confirmed_by_user_id_fk" FOREIGN KEY ("confirmed_by") REFERENCES "public"."user"("id") ON DELETE set null ON UPDATE no action;